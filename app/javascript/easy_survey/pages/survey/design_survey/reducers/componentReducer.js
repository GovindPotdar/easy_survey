...
export const componentReducer = (state = INITIAL_STATE, action) => {
  switch (action.type) {
    ...
    case 'UNDO':
      ...
      const futureComponents_undo = state.future.unshift(state.present);
      const pastComponents_undo = state.past;
      const presentComponent_undo = pastComponents_undo.pop();
      return { ...state, past: pastComponents_undo, present: presentComponent_undo, future: futureComponents_undo };
    case 'REDO':
      ...
      return { ...state, past: pastComponents_redo, present: presentComponent_redo, future: futureComponents_redo };
    default:
      return state;
    }
};
