...
function FieldElement({ id: componentId, field, text, x_axis, y_axis, updateComponent, selectedComponentId, dispatch}) {
  ...
  if (field === 'label') {
    return (
      <div
        ...
        onBlur={blurHandler} 
        onMouseDown={(e) => mouseDownHandler(e, updateComponent, componentId)} 
        onClick={()=>clickHandler(componentId, dispatch)}
        onInput={(e)=>labelTextChangeHandler(e, updateComponent, componentId)}  
      >
